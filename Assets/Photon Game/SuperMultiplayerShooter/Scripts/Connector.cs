    ...
    public class Connector : MonoBehaviourPunCallbacks
    {
      ...
      //  public string[] botPrefixes;                // names for bots
       ...
       bool inCustom;
        ...
        public bool whenIsayStart = false;
        public GameObject /*mainCam,*/uian,Env,loadingScreenNew;
        ...
        public override void OnJoinedLobby()
        {
            if(firstmake)
            {
                ...
                RegionSelection.instance.RegionDropDown.value = RegionSelection.ConvertCodeToRegion(PhotonNetwork.CloudRegion);
               // RegionSelection.instance.RegionDropDown.onValueChanged.AddListener(ChangeRegion);
                firstmake = false;
            }
        ...
        void ChangeRegion(int value)
        {
            ...
            PhotonNetwork.ConnectToRegion(RegionSelection.ConvertRegionToCode(value));
            dropDown.SetActive(true);
        }
        ...
        public override void OnJoinedRoom()
        {
            ...
            LoadNextScene();
                ...
                loadingScreenNew.SetActive(false);
          
           uian.SetActive(false);
            Env.SetActive(true);
